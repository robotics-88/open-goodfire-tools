...
def generate_sparse(images_path, database_path, sparse_path):
    ...
    colmap_container = client.containers.run('colmap/colmap:latest', 'sleep infinity', auto_remove=False, detach=True, runtime='nvidia', mounts=[images_mount, sparse_mount, db_mount])
